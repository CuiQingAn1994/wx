<template>
	<section class="detail">
		...
		<div v-else>
			...
			<div class="price">付款金额<span class="allPrice">{{good.priceNum/1200 | currency('¥',2)}}</span></div>
			...
			<div v-if="!(data.step==1000)">
				...
				<div class="del">
					...
					<!-- <p><span class="msg_name">设备SN码</span><span class="msg_con">{{}}</span></p>
					<p><span class="msg_name">订单编号</span><span class="msg_con">{{}}</span></p> -->
				</div>
			</div>
		</div>
