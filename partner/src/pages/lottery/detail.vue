  ...
  <section class="order" >
    ...
    <div v-else :style="{display:display}">
      <div class="header" v-if="data.lotteryName=='11选5'||data.lotteryName=='大乐透'||data.lotteryName=='竞足'">
        <div class="left">
          <img v-if="data.lotteryName=='11选5'" src="./img/11xuan5.png" alt="">
          <img v-if="data.lotteryName=='大乐透'" src="./img/daletou.png" alt="">
          <img v-if="data.lotteryName=='竞足'" src="./img/zucai.png" alt="">
        </div>
      ...
      <div class="line" v-if="data.order_status==1"></div>
      <div class="thanks" style="color: red" v-if="data.lotteryName=='竞足'&&data.order_status==1">您有{{orderNo}}个子订单需要出票&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;共计{{data.tableData.investCount}}注{{data.tableData.investCount*2}}元</div>
      <div class="thanks" v-if="data.lotteryName=='11选5'|| data.lotteryName=='大乐透'">感谢您助力公益事业~</div>
      ...
      <div class="project">
        ...
        <div class="zc" v-if="data.lotteryName=='竞足'">
          <!--<p class="play">
            <div class="zcPlay">倍数&nbsp;:&nbsp;<i  v-if="data.lotteryName=='竞足'" >{{data.tableData.investCount}}注{{data.tableData.multiple}}倍</i>
            </div>
          &lt;!&ndash;<div class="zcPlay"  >过关方式&nbsp;:&ndash;&gt;
            &lt;!&ndash;<i  v-if="data.tableData.playType==0" >单关</i>&ndash;&gt;
            &lt;!&ndash;<i  v-if="data.tableData.playType!=0">{{data.tableData.playType}}串1</i>&ndash;&gt;
          &lt;!&ndash;</div>&ndash;&gt;
          </p>-->
          <!-- 胜平负 比分-->
          <div v-for="(itemBig,indexBig) in data.tableData.dzList" v-if="data.tableData.playName=='spf'||data.tableData.playName=='bf'||data.tableData.playName=='jqs'||data.tableData.playName=='bqc'">
            <p><span style="display:block;width:100%;height: 10px;background: #f6f6f6;"></span></p>
            <p><span style="display:block;width:100%;height: 30px;text-align: center;line-height: 30px;color: #666;border-left: 1px solid #eee;border-right: 1px solid #eee;border-top: 1px solid #eee;background: #f9f9f9;">订单{{indexBig+1}}&nbsp;&nbsp;&nbsp;&nbsp;{{data.tableData.multiple}}倍</span></p>
            <div class="team" v-if="data.tableData.playName=='spf'||data.tableData.playName=='bf'||data.tableData.playName=='jqs'||data.tableData.playName=='bqc'">
              <span>主队VS客队</span>
              <span class="center">玩法</span>
              <span>所选结果</span>
            </div>
            <ul class="game" v-for="(item,index) in itemBig" v-if="data.tableData.playName=='spf'||data.tableData.playName=='bf'||data.tableData.playName=='jqs'||data.tableData.playName=='bqc'" >
              ...
              <li class="gameResult" style="border-right:1px solid #eee;">
                <i v-if="data.tableData.playName=='spf'">胜平负</i>
                <i v-if="data.tableData.playName=='bf'">比分</i>
                <i v-if="data.tableData.playName=='jqs'">进球数</i>
                <i v-if="data.tableData.playName=='bqc'">半全场</i>
              </li>
              <li style="padding-top:0px;">
                ...
                <div  v-if="data.tableData.playName=='bf'">
                  ...
                  <div @click="more(indexBig,index)" v-if="item.liveSp.length>3">
                    <i  style="lineHeight:60px;display:block;" v-for="bfItem in item.liveSp">点击查看</i>
                  </div>
                </div>
          ...
          <!-- 让球胜平负 -->
          <div v-for="(itemXBig,indexXBig) in data.tableData.dzList" v-if="data.tableData.playName=='xspf'">
            <p><span style="display:block;width:100%;height: 10px;background: #f6f6f6;"></span></p>
            <!--<div class="line"></div>-->
            <p><span style="display:block;width:100%;height: 30px;text-align: center;line-height: 30px;color: #666;border-left: 1px solid #eee;border-right: 1px solid #eee;border-top: 1px solid #eee;background: #f9f9f9;">订单{{indexXBig+1}}&nbsp;&nbsp;&nbsp;&nbsp;{{data.tableData.multiple}}倍</span></p>
            <div class="team" v-if="data.tableData.playName=='xspf'">
              <span style="width:40%">主队VS客队</span>
              <span style="width:15%" class="center">玩法</span>
              <span style="width:30%" >所选结果</span>
              <span style="width:15%" >让球</span>
            </div>
            <ul class="game" v-for="item in itemXBig" v-if="data.tableData.playName=='xspf'" >
            ...
            <div class="moreCon">
              <div class="content clearfix">
                <div class="moreResult">
                  <div class="bfTItle more_font_style" v-if="data.tableData.playName=='bf'" >比分</div>
                  <div class="bfTItle more_font_style" v-if="data.tableData.playName=='jqs'">进球数</div>
                  <div class="bfTItle more_font_style"  v-if="data.tableData.playName=='bqc'">半全场</div>
                  <div class="bfTItle">赔率</div>
                </div>
                <div class="moreResult" v-if="data.tableData.dzList[childIdx][idx].liveSp.length>1">
                  <div class="bfTItle more_font_style" v-if="data.tableData.playName=='bf'" >比分</div>
                  <div class="bfTItle more_font_style" v-if="data.tableData.playName=='jqs'">进球数</div>
                  <div class="bfTItle more_font_style"  v-if="data.tableData.playName=='bqc'">半全场</div>
                  <div class="bfTItle">赔率</div>
                </div>
                <div v-for="moreItem in data.tableData.dzList[childIdx][idx].liveSp" class="moreResult">
                  <div class="bfTItle more_font_style" v-if="data.tableData.playName=='bf'" >{{moreItem.BF}}</div>
                  <div class="bfTItle more_font_style" v-if="data.tableData.playName=='jqs'" >{{moreItem.QS}}</div>
                  <div class="bfTItle more_font_style" v-if="data.tableData.playName=='bqc'" >{{moreItem.BQC}}</div>
      ...
      <div class="msg">
        ...
        <p class="betMsg" v-if="data.lotteryName=='11选5'||data.lotteryName=='大乐透'">
      ...
      <!--<div class="hint" v-if="data.type=='REMOTE'">
        ...
        &lt;!&ndash; <div class="line" style="borderBottomColor:#aaa" ></div>
          &ndash;&gt;
      ...
      <div class="hint">
        ...
        <p>1. 如有疑问，请联系和彩宝客服 400 689 3373 。</p>
        <p>2. 工作时间：周一 —— 周五（10:00-18:30）。</p>
      </div>
      <div class="refund" v-if="data.order_status==1" @click="refund">申请退款</div>
    </div>
    <loading v-if="zhuan"></loading>
    <modals v-if="modelShow" title="是否退款给该订单用户"></modals>
...
//            console.log("订单详情",res)
            ...
            if(me.data.lotteryName == '竞足'){
              me.orderNo = me.data.tableData.dzList.length;
            }
          }
        },function(err){
          me.zhuan = false;
      ...
      more(indexBig,index){
        this.childIdx = indexBig;
        this.idx = index;
//        console.log(indexBig);
//        console.log(this.idx);
//        console.log(this.data.tableData.dzList[this.childIdx]);
        this.moreBet = true;
      ...
      confirm(){
        ...
        _this.zhuan = true;
        _this.$http.post(_config.lottery+'/hecai/orderRefund',params).then((res)=>{
          console.log(res.data);
          setTimeout(function(){
            _this.zhuan = false;
          }, 200)
